...
use App\Http\Controllers\Admin\AdminEmployesController;
...
Route::group(['prefix' => 'staff'], function () {
    Route::group(['middleware' => 'auth:staff'], function () {
        ...
        Route::get('/post/ticket/change_status/{ticket_id}', [StaffController::class, 'change_status'])->name('staff.post.change_status');
        Route::get('/post/ticket/view_ticket/{ticket_id}', [StaffController::class, 'view_ticket'])->name('staff.ticket.view_ticket');
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => 'auth:admin'], function () {
        ...
        // Employes management
        Route::get('/employes/index/', [AdminEmployesController::class, 'index'])->name('admin.employes.index');
        Route::get('/employes/add/', [AdminEmployesController::class, 'add'])->name('admin.employes.add');
        Route::post('/employes/store/', [AdminEmployesController::class, 'store'])->name('admin.employes.store');
        Route::get('/employes/edit/{email}', [AdminEmployesController::class, 'edit'])->name('admin.employes.edit');
        Route::post('/employes/update/{email}', [AdminEmployesController::class, 'update'])->name('admin.employes.update');
        Route::get('/employes/findusername', [AdminEmployesController::class, 'findusername'])->name('admin.findusername'); 
        //Admin Pages
...
Route::group(['middleware' => 'user.redirect'], function () {
    ...
    })->name('user.how_it_work');
    Route::get('/quick-rule', function () {
        return view('User.quick_rule');
    })->name('user.quick_rule');
    Route::get('/what-wasetak', function () {
        return view('User.what_wasetak');
    })->name('user.what_wasetak');
    Route::get('/rewards-rules', function () {
        return view('User.rewards_rules');
    })->name('user.rewards_rules');
    Route::get('/rewards', function () {
        return view('User.rewards');
    })->name('user.rewards');
    Route::get('/how-it-use', function () {
        return view('User.how_it_use');
    })->name('user.how_it_use');
    Route::get('/ways-to-earn', function () {
        return view('User.ways_to_earn');
    })->name('user.ways_to_earn');
    Route::get('/top-earners', function () {
        return view('User.top_earners');
    })->name('user.top_earners');
    Route::get('/frequently-asked-question', function () {
        return view('User.frequently_asked_question');
    })->name('user.frequently_asked_question');
    Route::get('/start-checkout', function () {
        return view('User.start_checkout');
    })->name('user.start_checkout');
    Route::get('/fee-calculator', function () {
        return view('User.fee_calculator');
    })->name('user.fee_calculator');
    Route::get('/begin-a-transaction', function () {
        return view('User.begin_a_transaction');
    })->name('user.begin_a_transaction');
    Route::get('/stay-connected', function () {
        return view('User.stay_connected');
    })->name('user.stay_connected');
    ...
    Route::get('/create-topics', function () {
        return view('User.create_topic');
    })->name('user.create_topic');
