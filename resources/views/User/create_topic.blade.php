...
<section class="sec4">
    <div class="container">
        <div class="row">
            <div class="col-md-11">
                <div class="boxed1">
                    <img src="{{asset('user_asset/img/card16.png')}}" alt="">
                    <div>
                        <h4>Hooper</h4>
                        <span><i class="fas fa-badge-check"></i> Verified Identity</span>
                    </div>
                </div>
                <h1>#1 Instagram Entrepreneur, Business, Model, Musician Verification | Username Claim | Unbans | PR + Verfication Guaranteed Packages</h1>
                <div class="boxed2">
                ...
                <div class="boxed4">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <span dir="ltr"> 256 replies <img src="{{asset('user_asset/img/card14.png')}}" alt=""></span>
