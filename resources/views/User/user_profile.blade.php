                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="boxed-imaged modalButton" data-popup="popupTen">
                                    <img src="{{asset('/assets/images/card16.png')}}" class="img1" alt="">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="normal">
                            <a href="#" class=" dropbtn-normal"><i class="fas fa-sort-down"></i> Normal <img
                                    src="{{asset('/assets/images/card128.png')}}" alt=""></a>
                ...
                <div class="col-md-12">
                                    ...
                                    <div class="boxed">
                                        <div class="row align-items-start">
                                            ...
                                            <div class="col-md-3 text-e">
                                                ...
                                                <a href="#" class="del">
                                                    <img src="{{asset('/assets/images/card61.png')}}" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    @foreach ($my_bookmark_posts as $my_bookmark_post)
                                        <div class="boxed">
                                            <div class="row align-items-center">
                                                <div class="col-md-8">
                                                    <div class="time"><span> 
                                                        <img src="{{asset('/assets/images/card64.png')}}"
                                                                alt=""> At
                    ...
                    <div class="box-4 activity message ticket">
                        ...
                        <div class="row">
                            <div class="col-md-2 px-md-0">
                                <ul class="list">
                                    <li data-targetit="box-25" class="inbox active"><img src="{{asset('/assets/images/card65.png')}}"
