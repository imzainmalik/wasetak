    ...
    <section class="modalWrapper">
        <div class="bookmark">
            ...
            <div class="remind">
                <h4>Remind me</h4>
                <ul>
                    <li><img src="{{ asset('user_asset/img/card100.png') }}" alt=""><a href="#">Later
                            Today</a></li>
                    <li><img src="{{ asset('user_asset/img/card101.png') }}" alt=""><a
                            href="#">Tomorrow</a></li>
                    <li><img src="{{ asset('user_asset/img/card102.png') }}" alt=""><a href="#">This
                            Weekend</a></li>
                    <li><img src="{{ asset('user_asset/img/card103.png') }}" alt=""><a
                            href="#">Monday</a></li>
                    <li><img src="{{ asset('user_asset/img/card104.png') }}" alt=""><a href="#">Next
                            Month</a></li>
                    <li><img src="{{ asset('user_asset/img/card105.png') }}" alt=""><a href="#">Last
                            custom date time</a></li>
                </ul>
            </div>
            <div class="reminder">
