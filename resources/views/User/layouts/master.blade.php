...
<body>
    ...
    <div class="modal fade" id="addtoany" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
                            ...
                            success: function(data) {
                                ...
                                if (data.status == true) {
                                    ...
                                    window.location.href =
                                        "{{ url('register-verification') }}/" + data.token;
                                    // }, 500);
                            ...
                            remote: {
                                ...
                                dataFilter: function(response) {
                                    ...
                                    if (jsonResponse.valid == false) {
                                        ...
                                        var message =
                                            "An error occur: You supplied invalid parameters to the request: login";
                                        return "\"" + message + "\"";
                                    }
                                }
                            }
