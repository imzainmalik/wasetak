<div id="item_payment_method_selection_div" class="d-none">
   ...
   <div class="row justify-content-center min_height">
      <div class="col-md-6">
       <select class="form-control form-select custom-select" placeholder="Choose" name="item_payment_method" id="payment_method">
