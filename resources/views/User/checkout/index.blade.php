            ...
            <form id="form_begin_transaction">
                ...
                <div class="row align-items-center">
                    <div class="col-md-4 sta_mt">
                        <input type="text" class="form-control" placeholder="Buyers Email" id="buyer_email" name="buyer_email" onkeyup="checkBtnBeginTransaction()">
                    </div>
                    <div class="col-md-4">
                        <img src="{{ asset('user_asset/img/swap.png') }}">
                    </div>
                    <div class="col-md-4">
                        <input type="text" class="form-control" placeholder="Sellers Email" id="seller_email" name="seller_email" onkeyup="checkBtnBeginTransaction()">
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>If you're unable to locate the member, it means he/she doesn't have a {{config('app.name')}} account. Send the user an invite by using the form below. You will be notified once he/she becomes a member. Once that happens, please start the transaction again.</p>
                <div class="row">
                <div class="col-md-8">
                    <input type="text" class="form-control" placeholder="Email Address" id="send_invite_email_id" name="send_invite_email_id">
                    <div class="btn-group">
                        <button class="button" type="button"  id="btn-send-invite">Save <span class="spinner-border d-none" role="status"></span></button>
...
@else
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>The email <b id="email"></b> is already registered. <br/>
                  Is that you? <a data-bs-toggle="modal" class="alreadyAccount" data-bs-target="#login" href="javascript:void(0)">Log in to your account.</a><br/>
                Not you? <a data-bs-toggle="modal" class="dontHaveAccount" data-bs-target="#signup" href="javascript:void(0)">Register to continue.</a></p>
                <button class="button" data-bs-dismiss="modal">Ok</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <!-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
            <div class="modal-body">
                <p>It seems none of these emails are registered on {{config('app.name')}}. If you would like to continue, both parties will need to register. To send invites to both emails, click the button below. Once you register a new account, please come back to this page to start the transaction. </p>
                <div class="row">
                <div class="col-md-8">
                        <div class="btn-group">
                            <button class="button" type="button" id="btn-send-invites">Send Invites <span class="spinner-border d-none" role="status"></span></button>
...
<script>
    @if(!Auth::check())
        ...
        function checkBtnBeginTransaction(){
            ...
            if(buyer_email.trim().length > 0 && seller_email.trim().length > 0 && regex.test(buyer_email) && regex.test(seller_email)){   
    ...
    @else
        ...
        $( document ).ready(function() {
                             ...
                             if(res.status){
                                ...
                                if(res.list.length > 0){
                                    ...
                                    $.each(res.list,function(index,val){
                                        ...
                                        list_html += "<li id='li_user_"+val.id+"' onclick='selectUser(this)'><img src='"+img+"'> "+val.username+"</li>";
            ...
            $('#buyer_seller_type_select_div .custom-option').on('click',function(){
                customSelectOptionClick(this);
                buyer_seller_type = $(this).attr('data-value');
            ...
            $('#item_or_service_type_select_div .custom-option').on('click',function(){
                customSelectOptionClick(this);
                item_service_type = $(this).attr('data-value');
            ...
            $('#btn_choose_item_or_service_type').on('click',function(){
                if(buyer_seller_type == 'Buyer'){
                    ...
                    nextBackStepClickManage('choose_item_or_service_type_div','seller_describe_service_div');
